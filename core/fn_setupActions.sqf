...
switch (playerSide) do
{
	...
	case civilian:
	{
		...
		//Restrain Action
		life_actions = [player addAction["Fesseln",life_fnc_restrainAction,cursorTarget,9999999,false,false,"",' 
		...
		//Escort
		life_actions = life_actions + [player addAction["Abführen",life_fnc_escortAction,[cursorTarget],0,false,false,"",'
		...
		life_actions = life_actions + [player addAction["Ins Fahrzeug setzen",life_fnc_putInCar,"",0,false,false,"",
		' !isNull cursorTarget && (player distance cursorTarget) < 6 && speed cursorTarget < 2 && cursorTarget isKindOf "Car" && ((((position player) nearEntities [["Man"],5]) select 0) getVariable "Escorting")' ]];
		//life_actions = life_actions + [player addAction["Ins Fahrzeug setzen",life_fnc_putInCar,_unit,0,false,false,"",
		//' !isNull cursorTarget && (player distance cursorTarget) < 6 && speed cursorTarget < 2 && cursorTarget isKindOf "Air"' ]];
		life_actions = life_actions + [player addAction["Ins Fahrzeug setzen",life_fnc_putInCar,_unit,0,false,false,"",
		' !isNull cursorTarget && (player distance cursorTarget) < 6 && speed cursorTarget < 2 && cursorTarget isKindOf "Ship"' ]];
		life_actions = life_actions + [player addAction["Abführen stoppen",life_fnc_stopEscorting,_unit,0,false,false,"",
		' !isNull cursorTarget && cursorTarget isKindOf "Man" && (isPlayer cursorTarget) && animationState cursorTarget == "AmovPercMstpSnonWnonDnon_Ease" && (side cursorTarget == civilian) && player distance cursorTarget < 3.5 && (cursorTarget getVariable "Escorting")']];
		life_actions = life_actions + [player addAction["Entfesseln",life_fnc_unrestrain,cursorTarget,0,false,false,"",
		...
		//Houses
		life_actions = life_actions + [player addAction["<t color='#FF0000'>Toggle House Locks</t>",life_fnc_lockHouse,cursorTarget,9999999,false,false,"",'!isNull cursorTarget && (player distance cursorTarget) < 20 && cursorTarget isKindOf "House" && license_civ_home && (getPlayerUID player) in (cursorTarget getVariable["life_homeOwners", []])']];
		life_actions = life_actions + [player addAction["<t color='#00FF00'>House Menu</t>",life_fnc_houseMenu,cursorTarget,9999999,false,false,"",'!isNull cursorTarget && (player distance cursorTarget) < 20 && cursorTarget isKindOf "House" && ([typeOf cursorTarget] call life_fnc_housePrice) > -1 && !(([cursorTarget] call life_fnc_getBuildID) in life_public_houses)']];
		life_actions = life_actions + [player addAction["Item Storage",life_fnc_openStorage,cursorTarget,9999999,false,false,"",' !isNull cursorTarget && (player distance cursorTarget) < 6 && cursorTarget isKindOf "House"  && speed cursorTarget < 2 && (count (cursorTarget getVariable["containers", []]) > 0) && license_civ_home && ((getPlayerUID player) in (cursorTarget getVariable["life_homeOwners", []]) || ((cursorTarget getVariable["life_locked", 1]) == 0))']];// || !(cursorTarget getVariable["life_locked", true])
		life_actions = life_actions + [player addAction["Vehicle Garage",life_fnc_vehicleGarage,"car",0,false,false,"",' !isNull cursorTarget && (player distance cursorTarget) < 20 && cursorTarget isKindOf "House" && (typeOf cursorTarget == "Land_i_Garage_V1_F" || typeOf cursorTarget == "Land_i_Garage_V2_F" || typeOf cursorTarget == "Land_i_Garage_V1_dam_F") && (((getPlayerUID player) in (cursorTarget getVariable["life_homeOwners", []])) || ((cursorTarget getVariable["life_locked", 1]) == 0)) ']];
		life_actions = life_actions + [player addAction["Store Vehicle in Garage",life_fnc_storeVehicle,"""",0,false,false,"""",' !life_garage_store && !isNull cursorTarget && (player distance cursorTarget) < 20 && cursorTarget isKindOf "House" && (typeOf cursorTarget == "Land_i_Garage_V1_F" || typeOf cursorTarget == "Land_i_Garage_V2_F" || typeOf cursorTarget == "Land_i_Garage_V1_dam_F") && (((getPlayerUID player) in (cursorTarget getVariable["life_homeOwners", []])) || (cursorTarget getVariable["life_locked", 1]) == 0) ']];
	};
};
